...
export default function ResetPassword() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-slate-200 ">
            ...
            {/*Email Form */}
            {!isEmailSent && (
                <form onSubmit={handleEmailSubmit} className="bg-white p-10 rounded-lg shadow-lg w-full max-w-sm flex flex-col items-center gap-6">
                    <h1 className="text-4xl font-semibold text-center mb-4 text-black">Reset Password</h1>
                    ...
                    <button type="submit" className="w-full py-2 rounded-full bg-black text-white font-medium">Submit</button>
                </form>
            )}
            ...
            {isEmailSent && !isOtpSubmitted && (
                <form onSubmit={handleOtpSubmit} onPaste={handlePaste} className="bg-white p-10 rounded-lg shadow-lg w-full max-w-sm flex flex-col items-center gap-6">
                    ...
                    <button type="submit" className="w-full py-2 rounded-full bg-black text-white font-medium">Verify</button>
                </form>
            )}

            {/*New Password Form */}
            {isEmailSent && isOtpSubmitted && (
                <form onSubmit={handlePasswordSubmit} className="bg-white p-10 rounded-lg shadow-lg w-full max-w-sm flex flex-col items-center gap-6">
                    <h1 className="text-4xl font-semibold text-center mb-4 text-black">Set New Password</h1>
                    <p className="text-center mb-6 text-black">Enter your new password below</p>
