...
export default function Login() {
    ...
    const initialMode = searchParams.get('mode') === 'signup' ? 'Sign Up' : 'Login'
    ...
    return (
        <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-slate-200 ">
            ...
            <button onClick={() => navigate('/')} className="  rounded-lg shadow-lg bg-black  fixed bottom-4 right-4 px-4 py-2 text-sm text-white"> Back to Home </button>
        </div>
