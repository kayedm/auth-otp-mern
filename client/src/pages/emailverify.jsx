...
export default function OtpVerify() {
    const { backendUrl, getUserData, userData, loadingUser } = useContext(AppContext)
    ...
    return (
        <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-slate-200 ">
            <form onSubmit={handleSubmit} onPaste={handlePaste} className="bg-white p-10 rounded-lg shadow-lg w-full max-w-sm flex flex-col items-center gap-6">
                <h1 className="text-4xl font-semibold text-center mb-4 text-black">Email Verify OTP</h1>
                ...
                <button type="submit" className="w-full py-2 rounded-full bg-black text-white font-medium transition">Verify</button>
            </form>
        </div>
    )
}
